...
AVRDUDE_WRITE_FLASH = -U flash:w:$(OBJDIR)/$(TARGET).elf
AVRDUDE_WRITE_EFUSE = -U efuse:w:$(OBJDIR)/$(TARGET).elf
AVRDUDE_WRITE_HFUSE = -U hfuse:w:$(OBJDIR)/$(TARGET).elf
AVRDUDE_WRITE_LFUSE = -U lfuse:w:$(OBJDIR)/$(TARGET).elf
#AVRDUDE_WRITE_EEPROM = -U eeprom:w:$(OBJDIR)/$(TARGET).elf
...
all: begin gccversion sizebefore clean build sizeafter end
...
program: $(OBJDIR)/$(TARGET).elf
	$(AVRDUDE) $(AVRDUDE_FLAGS) $(AVRDUDE_WRITE_FLASH) $(AVRDUDE_WRITE_EEPROM) $(AVRDUDE_WRITE_EFUSE) $(AVRDUDE_WRITE_HFUSE) $(AVRDUDE_WRITE_LFUSE)
